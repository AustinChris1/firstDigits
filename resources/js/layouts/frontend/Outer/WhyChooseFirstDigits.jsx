      ...
      <div className="p-5 sm:p-10 flex flex-col items-center text-center">
        <div className="mt-20">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-blue-900 dark:text-blue-400 text-4xl sm:text-5xl mb-6 font-bold"
          >
          ...
          <div className="flex flex-col items-center justify-center">
            <motion.p
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="text-gray-600 dark:text-gray-300 mb-10 text-lg sm:text-xl max-w-3xl"
            >
          ...
          <div className="max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-5 text-left border border-gray-300 dark:border-gray-700"
              >
                <h3 className="text-xl font-semibold text-blue-900 dark:text-blue-400 flex items-center mb-4">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            >
              <h2 className="text-2xl font-bold text-blue-900 dark:text-blue-400 mb-4">Join Us on Our Journey!</h2>
              ...
              <button className="bg-green-600 dark:bg-green-700 text-white py-2 px-4 rounded hover:bg-green-700 dark:hover:bg-green-800 transition duration-300">
                Get Started
              </button>
            </motion.div>
          </div>
