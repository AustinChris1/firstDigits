        ...
        <div className="max-w-4xl w-full">
          {faqs.map((faq, index) => (
            <div key={index} className="mb-4">
              <motion.button
                className="flex justify-between items-center w-full bg-white rounded-lg shadow-md hover:shadow-lg p-4 text-left border border-gray-300 transition-transform duration-200 focus:outline-none"
              ...
              {activeIndex === index && (
                <motion.div
                  className="mt-2 bg-gray-50 p-4 rounded-lg shadow-lg"
