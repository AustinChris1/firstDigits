...
const AboutUs = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-blue-900 dark:bg-gray-900">
      {/* Background Image */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-5 sm:p-10 text-center bg-black/70 dark:bg-black/90">
        {/* About Us Header */}
        <div className="mt-20">
          <motion.h1
            ...
            viewport={{ once: true }}
            className="text-white text-4xl sm:text-5xl mb-6 font-bold dark:text-gray-100"
          >
          ...
          <motion.p
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="text-gray-200 mb-10 text-lg sm:text-xl max-w-3xl mx-auto dark:text-gray-300"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mb-20 max-w-6xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="bg-white rounded-lg shadow-lg p-5 text-left dark:bg-gray-800 dark:shadow-2xl"
            >
              <h2 className="text-xl font-semibold text-gray-800 flex items-center mb-4 dark:text-white">
          ...
          {/* Services */}
          <h2 className="text-3xl text-white mb-10 font-bold dark:text-gray-100">What We Do</h2>
          <div className="max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-20 mx-auto">
            <motion.div
              ...
              className="bg-white rounded-lg shadow-lg p-5 text-left dark:bg-gray-800 dark:shadow-2xl"
            >
              <h3 className="text-lg font-semibold text-gray-800 flex items-center mb-2 dark:text-white">
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 dark:text-gray-100">Join Us on Our Journey</h2>
            <p className="text-gray-200 mb-5 dark:text-gray-300">
            ...
            <button className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition duration-300 shadow-lg dark:bg-green-700 dark:hover:bg-green-600">
              Learn More
            </button>
          </motion.div>
        </div>
